...
public class TypeScriptLavaAngularClientCodegen extends AbstractTypeScriptClientCodegen {
    private final Logger LOGGER = LoggerFactory.getLogger(TypeScriptLavaAngularClientCodegen.class);
    ...
    public TypeScriptLavaAngularClientCodegen() {
        super();

        modifyFeatureSet(features -> features.includeDocumentationFeatures(DocumentationFeature.Readme));

        this.outputFolder = "generated-code/typescript-lava-angular";

        supportsMultipleInheritance = true;

        embeddedTemplateDir = templateDir = "typescript-lava-angular";

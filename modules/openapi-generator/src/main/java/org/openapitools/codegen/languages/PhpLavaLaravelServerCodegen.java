...
public class PhpLavaLaravelServerCodegen extends AbstractPhpCodegen {
    private final Logger LOGGER = LoggerFactory.getLogger(PhpLavaLaravelServerCodegen.class);
    ...
    public PhpLavaLaravelServerCodegen() {
        super();
        ...
        embeddedTemplateDir = templateDir = "php-lava-laravel";
    ...
    public String getName() {
        return "php-lava-laravel";
    }

    @Override
    public String getHelp() {
        return "Generates a PHP Lava-Laravel Framework server library(with Mock server).";
    }
